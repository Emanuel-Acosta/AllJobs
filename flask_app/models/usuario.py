...
class Usuario:
    ...
    @classmethod 
    def get_all(cls): # 1 Metodo para obtener todos los usuarios
    ...
    @classmethod
    def save(cls, data): # 2 Metodo para guardar un usuario
        query = """
    ...
    @classmethod
    def get_by_email(cls, email): # 3 Metodo para obtener un usuario por email
    ...
    @classmethod
    def get_by_id(cls, id): # 4 Metodo para obtener un usuario por id
    ...
    @staticmethod
    def validar_usuario(usuario): # 5 Metodo para validar un usuario
        is_valid = True
